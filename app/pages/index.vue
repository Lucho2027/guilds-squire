...
<template>
  <UCard>
    ...
    <p class="text-sm text-gray-700 dark:text-gray-300 italic">
      No personal informations regarding your Battlenet account are stored in database.<br>
      We store only the things created linked with your GitHub ID.
    </p>
  </UCard>
</template>
